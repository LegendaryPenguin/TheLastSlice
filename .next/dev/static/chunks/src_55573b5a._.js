...
function HostRoomPage() {
    ...
    const [moveSet, setMoveSet] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "HostRoomPage.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$moves$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pickFourRandomMoves"])()
    }["HostRoomPage.useState"]);
    // Load saved player for this raid (host can refresh and still be the same player)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostRoomPage.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostRoomPage.useEffect": ()=>{
            if (!raid?.id) return;
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseClient"].channel(`hostRaid:${raid.id}`).on("postgres_changes", {
                event: "*",
                schema: "public",
                table: "raids",
                filter: `id=eq.${raid.id}`
            }, {
                "HostRoomPage.useEffect.channel": (payload)=>{
                    const next = payload.new;
                    setRaid({
                        "HostRoomPage.useEffect.channel": (r)=>({
                                ...r,
                                ...next
                            })
                    }["HostRoomPage.useEffect.channel"]);
                }
            }["HostRoomPage.useEffect.channel"]).on("postgres_changes", {
                event: "*",
                schema: "public",
                table: "players",
                filter: `raid_id=eq.${raid.id}`
            }, {
                "HostRoomPage.useEffect.channel": async ()=>{
                ...
                "HostRoomPage.useEffect.channel": (payload)=>{
                    ...
                    setAttacks({
                        "HostRoomPage.useEffect.channel": (prev)=>[
                                atk,
                                ...prev
                            ].slice(0, 200)
                    }["HostRoomPage.useEffect.channel"]);
                }
            }["HostRoomPage.useEffect.channel"]).subscribe();
            return ({
                "HostRoomPage.useEffect": ()=>{
...
_s(HostRoomPage, "GC4T0A6za9sihWx5Mqo4urL47FQ=", false, function() {
    return [
...
_c = HostRoomPage;
var _c;
__turbopack_context__.k.register(_c, "HostRoomPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_55573b5a._.js.map